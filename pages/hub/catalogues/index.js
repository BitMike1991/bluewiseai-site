      ...
      <div className="max-w-3xl mx-auto p-8">
        ...
        >
          <p className="mb-3" style={{ color: "var(--d-text)" }}>
            Les catalogues fournisseurs sont actuellement sur{" "}
