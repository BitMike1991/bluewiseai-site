  ...
  <style>
    ...
    * { box-sizing: border-box; margin: 0; padding: 0; }
    ...
    @media print {
      ...
      /* Compact item cards so break-inside:avoid actually fits each card on a
         single page. avoid-page is silently ignored when content > page. */
      .item-card {
        break-inside: avoid;
      ...
      .item-grid { gap: 10px; margin-bottom: 14px; }
      .item-sketch { width: 86px; gap: 4px; }
      .item-sketch svg { max-width: 78px; max-height: 78px; }
      .item-sketch .dims { font-size: 9px; }
