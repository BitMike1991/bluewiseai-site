...
// Dedicated HMAC secret for OAuth state signing (falls back to app secret, then service role key)
const SECRET = process.env.OAUTH_STATE_SECRET || process.env.HMAC_SECRET || process.env.SUPABASE_SERVICE_ROLE_KEY;
