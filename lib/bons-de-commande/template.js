...
const FENETRE_DEFAULTS = [
  ...
  'Intercalaire à conductivité réduite',
...
const PORTE_DEFAULTS = [
  ...
  'Seuil aluminium anodisé clair',
  'Serrure standard 1 point',
  'Pentures finis argent',
  'Verrous de sécurité multi-points (option)',
  'Couleurs : extérieur Blanc · intérieur Blanc',
  'Coupe-bise rétractable certifié ENERGY STAR',
  'Garantie 20 ans panneau · 5 ans peinture',
];
